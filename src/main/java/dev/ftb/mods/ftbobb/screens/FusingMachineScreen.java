...
public class FusingMachineScreen extends FluidAndEnergyScreen<FusingMachineMenu> {
    private static final ResourceLocation TEXTURE = FTBOBB.id("textures/gui/fusing_machine_background.png");
